; LAW CERTIFICATE — tails∪: ∅, {ε}, singletons, ∪-distribution, wrap-heads
...
(assert (not (and
  (forall ((p Path)) (= (exists ((hh Int)) false) false))
  (forall ((p Path)) (= (exists ((hh Int)) (= (cons hh p) nil)) false))
  (forall ((h Int)) (forall ((p Path)) (= (exists ((hh Int)) (= (cons hh p) (cons h nil))) (= p nil))))
  (forall ((h Int) (t Path)) (forall ((p Path)) (= (exists ((hh Int)) (= (cons hh p) (cons h t))) (= p t))))
  (forall ((p Path)) (= (exists ((hh Int)) (or (A (cons hh p)) (B (cons hh p)))) (or (exists ((hh Int)) (A (cons hh p))) (exists ((hh Int)) (B (cons hh p))))))
  (forall ((h Int)) (forall ((p Path)) (= (exists ((hh Int)) (or (exists ((qq Path)) (and (= (cons hh p) (append (cons h nil) qq)) (A qq))) (B (cons hh p)))) (or (A p) (exists ((hh Int)) (B (cons hh p)))))))
  (forall ((h Int)) (forall ((p Path)) (= (exists ((hh Int)) (exists ((qq Path)) (and (= (cons hh p) (append (cons h nil) qq)) (A qq)))) (A p)))))))
(check-sat)
