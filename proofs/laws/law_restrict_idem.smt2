; LAW CERTIFICATE — restriction chains: (A<|B)<|B = A<|B and (A<|B)<|C = (A<|C)<|B
...
(assert (not (and
  ...
  (forall ((p Path)) (= (and (and (A p) (exists ((qq Path)) (and (B qq) (isPrefix qq p)))) (exists ((qq Path)) (and (C qq) (isPrefix qq p)))) (and (and (A p) (exists ((qq Path)) (and (C qq) (isPrefix qq p)))) (exists ((qq Path)) (and (B qq) (isPrefix qq p)))))))))
(check-sat)
