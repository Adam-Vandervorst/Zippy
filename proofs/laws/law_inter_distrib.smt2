; LAW CERTIFICATE — ∩ distributes over ∪ (both sides)
...
(assert (not (and
  (forall ((p Path)) (= (and (or (A p) (B p)) (C p)) (or (and (A p) (C p)) (and (B p) (C p)))))
  (forall ((p Path)) (= (and (A p) (or (B p) (C p))) (or (and (A p) (B p)) (and (A p) (C p))))))))
(check-sat)
