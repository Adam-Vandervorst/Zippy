; LAW CERTIFICATE — the De Morgan family for subtraction
...
(assert (not (and
  (forall ((p Path)) (= (and (A p) (not (or (B p) (C p)))) (and (and (A p) (not (B p))) (not (C p)))))
  (forall ((p Path)) (= (and (A p) (not (or (B p) (C p)))) (and (and (A p) (not (B p))) (and (A p) (not (C p))))))
  (forall ((p Path)) (= (and (A p) (not (and (B p) (C p)))) (or (and (A p) (not (B p))) (and (A p) (not (C p)))))))))
(check-sat)
