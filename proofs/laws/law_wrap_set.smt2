; LAW CERTIFICATE — wrap: ∅-absorption, ε-unit, singleton fusion, ∪-distribution
...
(assert (not (and
  (forall ((p Path)) (= (exists ((qq Path)) (and (= p (append w qq)) false)) false))
  (forall ((p Path)) (= (exists ((qq Path)) (and (= p (append nil qq)) (A qq))) (A p)))
  (forall ((p Path)) (= (exists ((qq Path)) (and (= p (append w qq)) (= qq u))) (= p (append w u))))
  (forall ((p Path)) (= (exists ((qq Path)) (and (= p (append w qq)) (or (A qq) (B qq)))) (or (exists ((qq Path)) (and (= p (append w qq)) (A qq))) (exists ((qq Path)) (and (= p (append w qq)) (B qq)))))))))
(check-sat)
