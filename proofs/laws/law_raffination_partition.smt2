; LAW CERTIFICATE — (A\|B) ∪ (A<|B) = A and (A\|B) ∩ (A<|B) = ∅
...
(assert (not (and
  ...
  (forall ((p Path)) (= (and (and (A p) (not (and (A p) (exists ((qq Path)) (and (B qq) (isPrefix qq p)))))) (and (A p) (exists ((qq Path)) (and (B qq) (isPrefix qq p))))) false)))))
(check-sat)
