; LAW CERTIFICATE — nested invariant iterations fuse and commute
...
(assert (not (and
  (forall ((p Path)) (= (and (exists ((hh Int) (tt Path)) (A (cons hh tt))) (and (exists ((hh Int) (tt Path)) (A (cons hh tt))) (B p))) (and (exists ((hh Int) (tt Path)) (A (cons hh tt))) (B p))))
  (forall ((p Path)) (= (and (exists ((hh Int) (tt Path)) (A (cons hh tt))) (and (exists ((hh Int) (tt Path)) (C (cons hh tt))) (B p))) (and (exists ((hh Int) (tt Path)) (C (cons hh tt))) (and (exists ((hh Int) (tt Path)) (A (cons hh tt))) (B p))))))))
(check-sat)
