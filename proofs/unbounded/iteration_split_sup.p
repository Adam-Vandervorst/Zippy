...
%
%
% THIS FILE: THE REVERSE INCLUSION.  Every path either component iteration
% produces is produced by the iteration over the merged source.
%
% VERDICT: PROVED by vampire in 15.0s.
...
tff(iteration_split_sup, conjecture,
    sub(cup(iter(a0,f0), iter(b0,f0)), iter(cup(a0,b0), f0)) ).
