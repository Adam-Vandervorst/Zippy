...
fof(conj, conjecture, ! [Z,I0,I1,I2,I3] : (zmem(cons(I0,cons(I1,cons(I2,cons(I3,nil)))),Z) <=> tmem(cons(I0,cons(I1,cons(I2,cons(I3,nil)))),ztrie(Z)))).
