...
; the known follow-up.
; KV-LIST REFINEMENT (cli): the sorted merge with ConsIf pruning implements, per key, the trie-level
...
(declare-fun tri (FT FT) FT)
(assert (forall ((x FT) (y FT) (p Path)) (= (memT (tri x y) p) (and (memT x p) (memT y p)))))
(declare-fun f (KV KV) KV)
(assert (forall ((b KV)) (= (f kvnil b) kvnil)))
(assert (forall ((a KV)) (= (f a kvnil) kvnil)))
(assert (forall ((k1 Int) (v1 FT) (r1 KV) (k2 Int) (v2 FT) (r2 KV))
  (=> (< k1 k2) (= (f (kvcons k1 v1 r1) (kvcons k2 v2 r2)) (f r1 (kvcons k2 v2 r2))))))
(assert (forall ((k1 Int) (v1 FT) (r1 KV) (k2 Int) (v2 FT) (r2 KV))
  (=> (< k2 k1) (= (f (kvcons k1 v1 r1) (kvcons k2 v2 r2)) (f (kvcons k1 v1 r1) r2)))))
(assert (forall ((k1 Int) (v1 FT) (r1 KV) (k2 Int) (v2 FT) (r2 KV))
  (=> (= k1 k2) (= (f (kvcons k1 v1 r1) (kvcons k2 v2 r2)) (consIf k1 (tri v1 v2) (f r1 r2))))))
...
(define-fun QQ ((a KV) (b KV)) Bool
  (=> (and (srt a) (srt b))
      (forall ((k Int) (q Path)) (= (memT (getk (f a b) k) q) (and (memT (getk a k) q) (memT (getk b k) q))))))
