; SPATIAL-TYPE CERTIFICATE (concretion) — CONCRETIZATION ORDER: interval inclusion (both endpoints) implies gamma-containment, and an UPPER-ENVELOPE-only comparison does NOT — the exact gap between the certified order and SpaceType.within
...
(assert (not (and (forall ((alo Int) (ahi Int) (blo Int) (bhi Int) (c Int))
