; SPATIAL-TYPE CERTIFICATE (concretion) — GALOIS CONNECTION: γ∘α is the identity on a concrete histogram, and α∘γ ⊑ id (per class)
...
(assert (not (forall ((l Int) (blo Int) (bhi Int))
