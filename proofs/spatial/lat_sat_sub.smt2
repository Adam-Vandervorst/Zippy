; SPATIAL-TYPE CERTIFICATE (lattice) — saturating relu-subtraction: monotone up in the minuend, DOWN in the subtrahend
...
(assert (not (and (forall ((a Cnt) (b Cnt)) (=> (and (okc a) (okc b)) (cle (fin 0) (csub a b))))
