; SPATIAL-TYPE CERTIFICATE (lattice) — both projections are monotone: a tighter type gives tighter size AND length bounds
...
(assert (not (and (forall ((a Ivl) (b Ivl) (c Ivl) (a2 Ivl) (b2 Ivl) (c2 Ivl))
