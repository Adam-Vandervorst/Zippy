; SPATIAL-TYPE CERTIFICATE (concretion) — UNWRAP SHIFTS CLASSES DOWN: every kept path comes from one source path |w| items longer
...
(assert (not (forall ((p Path)) (=> (MUnwrap p)
