; SPATIAL-TYPE CERTIFICATE (lattice) — saturating multiplication: commutative, 0-absorbing (0 beats ∞), monotone
...
(assert (not (and (forall ((a Cnt) (b Cnt)) (= (cmul a b) (cmul b a)))
