; SPATIAL-TYPE CERTIFICATE (lattice) — each transfer's interval CONTAINS the concrete count it must describe
...
(assert (not (and (forall ((na Int) (nb Int) (nu Int) (a Ivl) (b Ivl))
