; SPATIAL-TYPE CERTIFICATE (concretion) — the SYNTACTIC subsumptions the analysis exploits: ∩, ∖, <|, \| are all ⊆ their left operand, and each operand ⊆ ∪
