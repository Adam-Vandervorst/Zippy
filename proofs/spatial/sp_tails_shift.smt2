; SPATIAL-TYPE CERTIFICATE (concretion) — TAILS SHIFTS BY ONE, AND A NONEMPTY CLASS YIELDS ≥1 TAIL (the dedup lower bound)
...
(assert (not (and (forall ((p Path)) (=> (MTails p) (exists ((r Path)) (and (A r) (= (len r) (+ (len p) 1))))))
