; SPATIAL-TYPE CERTIFICATE (lattice) — the interval lattice is distributive (a product of two total orders)
...
(assert (not (and (forall ((a Ivl) (b Ivl) (c Ivl)) (= (ijoin a (imeet b c)) (imeet (ijoin a b) (ijoin a c))))
