; SPATIAL-TYPE CERTIFICATE (lattice) — join is the least upper bound and meet the greatest lower bound
...
(assert (not (and (forall ((a Ivl) (b Ivl)) (and (ile a (ijoin a b)) (ile b (ijoin a b))))
