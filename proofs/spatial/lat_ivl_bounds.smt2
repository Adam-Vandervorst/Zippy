; SPATIAL-TYPE CERTIFICATE (lattice) — ⊥ is the INCONSISTENT interval (the provably-empty marker), ⊤ is no-information; [0,0] is neither
...
(assert (not (and (forall ((a Ivl)) (=> (oki a) (and (ile bot a) (ile a top))))
