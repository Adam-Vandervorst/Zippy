; SPATIAL-TYPE CERTIFICATE (concretion) — COMPOSITION ADDS LENGTHS: every product path has a witnessing (left, right) class pair
...
(assert (not (and (forall ((p Path)) (=> (MComp p)
