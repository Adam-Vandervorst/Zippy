; SPATIAL-TYPE CERTIFICATE (concretion) — WRAP produces NOTHING ELSE: every wrapped path is |w| longer than a witnessing source path (⊆ direction)
...
(assert (not (forall ((p Path)) (=> (MWrap p)
