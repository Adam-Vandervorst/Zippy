...
(define-fun s_9 ((p Path)) Bool (= p (cons 12305 (cons 12305 nil))))
...
(define-fun s_17 ((p Path)) Bool (= p (cons 12302 (cons 12305 nil))))
...
(define-fun s_25 ((p Path)) Bool (= p (cons 12303 (cons 12305 nil))))
...
(define-fun s_1 ((p Path)) Bool (exists ((q_2 Path)) (and (= p (cons 12316 q_2)) (s_3 q_2))))
(define-fun sideA ((p Path)) Bool (or (= p (cons 12316 (cons 12302 (cons 12305 nil)))) (= p (cons 12316 (cons 12303 (cons 12305 nil)))) (= p (cons 12316 (cons 12305 (cons 12305 nil))))))
