...
; BOUNDARY: zipper
; AUTO-GENERATED pipeline stage 2 (aunt) — DATA-AGNOSTIC: transpileZ(program) vs the program.
...
; SHELL: 3 node(s) transpiled with EVERY source opaque (SpaceZipper.Opaque); read back
; SHELL CONSTRUCTORS: Wrap, Mention, Constant
; PROGRAM CONSTRUCTORS: Wrap, Iteration, Mention, Intersection, Subtraction, TailsUnion, Restriction, Unwrap, Constant, Concat, Deref
; BINDERS: Iteration
; CALLS: 
