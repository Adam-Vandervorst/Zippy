...
; BOUNDARY: zipper
; AUTO-GENERATED pipeline stage 2 (nqueens) — DATA-AGNOSTIC: transpileZ(program) vs the program.
...
; PROGRAM CONSTRUCTORS: Iteration, Subtraction, Unwrap, Literal, Constant, , Wrap, Union, Call, Deref, Mention, Concat
; BINDERS: Iteration
; CALLS: aoe
