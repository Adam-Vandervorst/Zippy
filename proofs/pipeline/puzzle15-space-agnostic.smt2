...
; LAW-JUSTIFIED-NO-RESIDUAL: all 2 differing pair(s) (of 2 candidates,
...
; LAW-JUSTIFIED pair 1: reduce-join: constant-ops + unwrap-concat-unwraps
;   certificate(s): constant-ops ⟶ GROUND — per-op threeway_*/impl_* characterizations, eval-gated (registry: constant-ops); unwrap-concat-unwraps ⟶ proofs/laws/law_unwrap_merge.smt2
