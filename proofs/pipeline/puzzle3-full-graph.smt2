; TRUSTS: law:algebraic-identities, law:constant-ops, law:iter-comp-right-hoist, law:iter-union-indep
...
; BOUNDARY: graph
; AUTO-GENERATED — pipeline graph (puzzle3-full), instance (data-agnostic obligation + differential)
