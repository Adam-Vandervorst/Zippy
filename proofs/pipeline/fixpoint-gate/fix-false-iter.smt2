; AUTO-GENERATED — FALSE fixpoint: wrong step
...
(assert (forall ((zq Path)) (=> (or (fix_4 zq) (and (or (= zq (cons 0 nil))) (in_src zq))) (fix_4 zq))))
...
; DERIVED-FROM: proofs/lean/Zippy/Positive.lean#Zippy.Space.fixpoint_is_lfp
(assert (=> (and (forall ((zr Path)) (=> (in_src zr) (fix_2 zr))) (forall ((zr Path)) (=> (or (fix_2 zr) (and (or (= zr (cons 0 nil))) (in_src zr))) (fix_2 zr)))) (forall ((zq Path)) (=> (fix_4 zq) (fix_2 zq)))))
