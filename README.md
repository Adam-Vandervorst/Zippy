...
read-only with respect to the repository. It currently refuses: the gates are red, and
`plan.md` says which.
...
the two renderings are literal-vs-literal — see `plan.md` (Track A′, item 4) for what that costs
