#!/usr/bin/env python3
"""THE UNIVERSAL ZIPPER REFINEMENT, AS FIRST-ORDER OBLIGATIONS.
...
def main():
    steps = []
    for ctor in ZIP:
        text = (f"; ZIPPER REFINEMENT, STEP `{ctor}`: the induction step of\n"
        ...
        steps.append(ctor)
    main_text = ("; UNIVERSAL ZIPPER REFINEMENT over the SYNTAX of the key-free local algebra .\n"
                 ";\n"
