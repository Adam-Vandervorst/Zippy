...
TOKEN_EXCEPTIONS = {
    ...
    ("plan.md", "scripts/check_determinism.sh"): "(e) proposed by plan.md task 0.2; delete when it exists",
    ("plan.md", "scripts/gates.py"): "(e) proposed by plan.md task 0.4; delete when it exists",
    ("plan.md", "scripts/check_lean.sh"): "(e) proposed by plan.md task 0.5; delete when it exists",
    ("plan.md", "src/main/scala/ArtifactSink.scala"): "(e) proposed by plan.md task 0.3; delete when it exists",
    ("plan.md", "src/test/scala/AlphaNormCheck.scala"): "(e) proposed by plan.md task 0.6; delete when it exists",
    ("plan.md", "src/main/scala/Certified.scala"): "(e) proposed by plan.md task 0.8; delete when it exists",
    ("plan.md", "proofs/pipeline/CLAIMS.tsv"): "(e) proposed by plan.md task 0.8 / 2A.1; delete when it exists",
    ("plan.md", "CLAIMS.tsv"): "(e) proposed by plan.md task 2A.1; delete when it exists",
